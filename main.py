...
class AddMovie(webapp2.RequestHandler):
    ...
    def post(self):
        ...
        bad_movie = False
        for m in terrible_movies:
            if m.lower() == new_movie.lower():
                bad_movie = True
        if new_movie in terrible_movies or bad_movie:
            error = "Trust me, you don't want to add '%s' to your Watchlist." % cgi.escape(new_movie)
            self.redirect("/?error="+error)
